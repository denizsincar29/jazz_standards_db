...
# 15.01.2025 (Go Rewrite)

- Полностью переписал проект на Go (стандартная библиотека HTTP + GORM)
- Добавлена PWA с оффлайн поддержкой и service worker
- Добавлена система пользовательских категорий
- Улучшен поиск и фильтрация стандартов
- Docker образ уменьшен с 200MB до 10MB
- Поддержка BASE_PATH для развёртывания на подпути
- Удалены все файлы Python
- Конфигурация через .env файл
- Интерактивный build.sh для установки